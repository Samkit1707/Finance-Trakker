...
const ctxEntertainment = document.getElementById('entertainmentChart').getContext('2d');
const entertainmentChart = new Chart(ctxEntertainment, {
    type: 'bar',
    data: {
        labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'],
        datasets: [{
...
const ctxTravelling = document.getElementById('travellingChart').getContext('2d');
const travellingChart = new Chart(ctxTravelling, {
    type: 'bar',
    data: {
        labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'],
        datasets: [{
            label: 'Travelling Expenses',
            data: [300, 250, 280, 320],
